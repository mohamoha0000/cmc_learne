...
export default {
    ...
    env: {
        PORT: port,
        AUTH_SECERT: process.env.AUTH_SECRET || "7bxJ*fz_d#F*T*Py",
        SERVER_SECRET: process.env.SECRET_KEY || "fzq8f48fz8f4qzz67zq",
        ...
        NEXT_DOMAIN_ID: process.env.NEXT_DOMAIN_ID || "64a33a866f5f8d99fdff25d9"
    },
    next: nextConfig
}